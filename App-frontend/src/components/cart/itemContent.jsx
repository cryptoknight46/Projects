    ...
    return(
       <div className="grid md:grid-cols-5 grid-cols-4 md:text-md text-sm gap-4 items-center border-[1px] border-slate-200 rounded-md lg:px-4 py-4  p-2">
            ...
            <div className="flex items-start gap-5 mt-3">
                ...
                className="flex items-center font-semibold space-x-2 px-4 py-1 text-xs border border-rose-600 text-rose-600 rounded-md hover:bg-red-50 transiton-colors duration-200 ">
        ...
        <div className="justify-self-center lg:text-[17px] text-sm text-slate-800 font-semibold">
