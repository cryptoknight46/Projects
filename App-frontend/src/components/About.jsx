            ...
            <div className="flex flex-col lg:flex-row justify-between items-center mb-12">
                <div className="w-full md:w-1/2 text-center md:text-left">
                    <p className="text-lg mb-4">
                        Welcome to our e-commerce store ! we are dedicated to providing best products and services to our customers.our mission is 
                        to offer a seamless shoping experience while ensuring the highest qaulity of our offerings</p>
                </div>
                <div className="w-full md:w-1/2 md-6 md:mb-0">
